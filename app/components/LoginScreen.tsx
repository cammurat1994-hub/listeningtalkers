...
export default function LoginScreen({
  ...
  const [showSignInOptions, setShowSignInOptions] =
    useState(false);

  const [allowEmails, setAllowEmails] =
    useState(false);
    ...
    <main className="min-h-screen bg-[#f7eee8] text-[#3b2f2f]">
      <section className="mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-5 max-w-xl text-lg leading-8 text-[#7a6258]">
          Practice English listening with calm stories and
          level-based quizzes.
        </p>
        ...
        <div className="mt-10 w-full max-w-md rounded-[2rem] border border-[#e0c7bb] bg-[#fffaf7] p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-[#7a6258]">
            Sign in to save your progress or continue as a
            guest.
          </p>
    ...
    {loadingEmail
      ...
      : "Continue with Email"}
                ...
                <label className="mt-5 flex items-start gap-3 text-sm text-[#7a6258]">
                  ...
                  <span>
                    I want to receive learning reminders
                    and product updates by email.
                  </span>
                </label>
